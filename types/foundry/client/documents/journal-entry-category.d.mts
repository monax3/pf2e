...
interface ClientBaseJournalEntryCategory<TParent extends JournalEntry | null>
    extends InstanceType<typeof ClientBaseJournalEntryCategory<TParent>> {}
...
export default interface JournalEntryCategory<TParent extends JournalEntry | null = JournalEntry | null>
    extends ClientBaseJournalEntryCategory<TParent> {
